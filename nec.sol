...
contract NEC is Context, IERC20, Ownable {
    ...
    string private _name = "Nash Equilibrium Token"; 
    ...
    address public constant blackHole = 0x100000000000000000000000000000000000dEaD;
    address private devReceiver=0x4ba40A82f8551ec3B59E627040537D59525eEA86;
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair && from != owner() &&  from != address(this) && from != fomoReceiver)
